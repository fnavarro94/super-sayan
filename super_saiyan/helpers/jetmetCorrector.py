...
from PhysicsTools.NanoTrees.helpers.jetSmearingHelper import jetSmearer
...
class JetMETCorrector(object):
    ...
    def beginJob(self):
        ...
        if self.jer is not None or self.jmr is not None:
            ...
            self.jetSmearer.jerInputFilePath = os.environ['CMSSW_BASE'] + "/src/PhysicsTools/NanoTrees/data/2016/jme/"
